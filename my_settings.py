...
vortThresh = 3.e-5 #threshold vorticity for whether feature is a cyclone (1/s)
htMax = 1500. #maximum ground height for an object to count..."low-level" fields are bogus over high terrain like Greenland, Tibet,...
...
fDirData = '/data01/tracks/sfcCyclone/2006-08/'
...
timeStart = dt.datetime(2006,8,10,0) #time=timeStart+iTime*deltaT
