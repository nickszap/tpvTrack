...
def demo():
  ...
  if (my_settings.doPreProc):
    ...
    elif (my_settings.inputType=='mpasRegrid'):
      mesh, cell0 = preProcess.demo_mpasRegrid(fMesh, filesData, fMetr, rEarth, dRegion, latThresh, my_settings.iTimeStart_fData, my_settings.iTimeEnd_fData, info=info)
      my_settings.inputType=='eraI'
    else:
    ...
    if (my_settings.inputType=='eraI'):
      ...
      mesh, cell0 = preProcess.demo_mpasRegrid(fMesh, [], fMetr, rEarth, dRegion, latThresh, my_settings.iTimeStart_fData, my_settings.iTimeEnd_fData)
      my_settings.inputType=='eraI'
    else:
      print "Unrecognized input type in my_settings: ",my_settings.inputType
