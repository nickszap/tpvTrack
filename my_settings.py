...
fDirData = '/raid1/nick/cases/2006/20060801/run/'
filesData = sorted(glob.glob(fDirData+'output.2006-08-01_00.00.*nc'),key=os.path.getmtime)
...
fDirSave = '/data02/cases/test_segment/testUnified/200608/mpas/'
